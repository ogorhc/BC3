...
| **No ~O parser** — ~O records fall to UnknownRecordParser, producing diagnostics but losing data                                                                                   | Affects 19-026 (296), 21-028 (206), Excesos-Mod (15)                               |
| **No ~G parser** — ~G (image/graphic attachment) unsupported                                                                                                                       | Affects 19-026 (1)                                                                 |
| **No ~H parser** — ~H (unknown type) unsupported                                                                                                                                   | Affects Excesos-Mod (1)                                                            |
| **Null byte handling** — no preprocessing step to strip NUL bytes                                                                                                                  | Affects Excesos-Mod (100% of lines contaminated)                                   |
...
| **Backslash in version string** — if `\` is always treated as subfield separator, `FIEBDC-3/2020\02102025` gets split incorrectly                                                  | Affects TSL, 250617_Mod                                                            |
